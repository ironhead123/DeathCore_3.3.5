...
if(NO_GIT)
  set(rev_date "2014-10-25 17:27:00 +1b3f")
  set(rev_hash "DeathCore 3.3.5a")
  ...
  if(NOT rev_info)
    ...
    Continuing anyway - note that the versionstring will be set to \"DeathCore 3.3.5a 2014-10-25 17:27:00 (Archived)\"")
    set(rev_date "2014-10-25 17:27:00 +1b3f")
    set(rev_hash "DeathCore 3.3.5a")
    set(rev_branch "Archived")
  else()
