...
public:
    ...
    {
        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "Selecione um item para fazer o Reforge:", 0, Melt(MAIN_MENU, 0));
        ...
        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TRAINER, "Remover os reforges", 0, Melt(SELECT_RESTORE, 0));
        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Atualizar", 0, Melt(MAIN_MENU, 0));
