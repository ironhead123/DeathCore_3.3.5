...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
		...
		/*player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Pandaren Male", GOSSIP_SENDER_MAIN, 46);*/
		/*player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Pandaren Female", GOSSIP_SENDER_MAIN, 47);*/
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
    {
        switch (action)
        {
			...
			case 46:
				player->CLOSE_GOSSIP_MENU();
				player->SetDisplayId(42028);
				break;
			case 47:
				player->CLOSE_GOSSIP_MENU();
				player->SetDisplayId(44076);
				break;
