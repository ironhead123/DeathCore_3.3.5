...
class npc_changer : public CreatureScript
{
	public:
		...
		bool OnGossipHello(Player * pPlayer, Creature * pCreature)
		{
			...
			pPlayer->ADD_GOSSIP_ITEM(4, "|cff00ff00|TInterface\\icons\\Achievement_Boss_Valanar:24|t|r Quero mudar a minha raça!", GOSSIP_SENDER_MAIN, 0);
		    pPlayer->ADD_GOSSIP_ITEM(4, "|cff00ff00|TInterface\\icons\\Spell_Arcane_Arcane04:24|t|r Quero mudar a minha fação!", GOSSIP_SENDER_MAIN, 1);
            pPlayer->ADD_GOSSIP_ITEM(4, "|cff00ff00|TInterface\\icons\\Achievement_General_HordeSlayer:24|t|r Quero personalizar o meu personagem!", GOSSIP_SENDER_MAIN, 2);
             pPlayer->ADD_GOSSIP_ITEM(4, "|cff00ff00|TInterface\\icons\\INV_MISC_TICKET_TAROT_STACK_01:24|t|r Quero mudar o meu nome!", GOSSIP_SENDER_MAIN, 3);
