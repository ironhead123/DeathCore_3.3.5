...
void _SendWorldChat(Player* player, string message)
{
   ...
   uint8 cheksSize = 118;//Change these if you want to add more words to the array.
	...
	case SEC_PLAYER:
		...
		{
			msg += "|TInterface/ICONS/INV_BannerPVP_02.png:16|t";
			msg += GetNameLink(player);
			msg += ":";
		}
		else
		{
			msg += "|TInterface/ICONS/INV_BannerPVP_01.png:16|t";
			msg += GetNameLink(player);
			msg += ":";
		}
		break;
			// Jogador Vip
	case SEC_VIP:
		msg += "[V.I.P]|TInterface/ICONS/Ability_Warrior_StalwartProtector.png:16|t";
		msg += GetNameLink(player);
		msg += ":";
		break;
			// Moderador - Divulgador
	case SEC_MODERATOR:
		msg += "[Divulgador] |TInterface/ICONS/Achievement_Dungeon_UtgardePinnacle.png:16|t";
		msg += GetNameLink(player);
		msg += ":";
		break;
			// Game Master Suporte
	case SEC_TRIAL_GM:
		msg += "[Game Master - Suporte] |TInterface/ICONS/Achievement_Dungeon_UtgardePinnacle_10man.png:16|t";
		msg += GetNameLink(player);
		msg += ":";
		break;
			// Game Master Evento
	case SEC_JUNIOR_GM:
		msg += "[Game Master - Evento] |TInterface/ICONS/Achievement_Dungeon_UtgardePinnacle_Heroic.png:16|t";
		msg += GetNameLink(player);
		msg += ":";
		break;
		// Game Master Lider
	case SEC_GAMEMASTER:
		msg += "[Game Master - Lider] |TInterface/ICONS/Achievement_Dungeon_UtgardePinnacle_Normal.png:16|t";
		msg += GetNameLink(player);
		msg += ":";
		break;
		// Programador
	case SEC_DEVELOPER:
		msg += "[Programador] |TInterface/ICONS/Achievement_Dungeon_UtgardePinnacle_25man.png:16|t";
		msg += GetNameLink(player);
		msg += ":";
		break;
		// Sub-Administrador
	case SEC_HEAD_OF_STAFF:
		msg += "[Sub-Administrador] |TInterface/ICONS/Achievement_Dungeon_UlduarRaid_IronDwarf_01.png:16|t";
		msg += GetNameLink(player);
		msg += ":";
		break;
		// Administrador
	case SEC_ADMINISTRATOR:
		msg += "[Administrador] |TInterface/ICONS/Ability_Rogue_MasterOfSubtlety.png:16|t";
		msg += GetNameLink(player);
		msg += ":";
		break;
		// Dono do Servidor
